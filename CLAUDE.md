...
- Use a dark spruce background even in light OS mode. No top navigation (including About), "The apps" heading/tagline, logo caption, location/byline, GitHub, or "Say hello" links. Beau's name appears once in the visible page, linked to his personal website in the footer; don't display the domain as a separate link.
